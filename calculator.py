...
# -*- coding: utf-8 -*-
"""
Created on Tue Jun  2 16:41:24 2020
...
(), +, -, *, / and numbers separated by spaces returns 
...
and divisions have a higher priority and should be 
performed left-to-right. Additions and subtractions 
...
class Calculator(object):
  def evaluate(self, string):
      ...
      #  parse_expr(string,evaluate=False)
      # # return eval(string)
